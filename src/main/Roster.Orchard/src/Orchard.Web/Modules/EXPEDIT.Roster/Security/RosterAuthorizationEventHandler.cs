...
namespace EXPEDIT.Roster.Security {
    [UsedImplicitly]
    public class RosterAuthorizationEventHandler : IAuthorizationServiceEventHandler {
        ...
        private static Permission GetOwnerVariation(Permission permission) {
            if (permission.Name == Permissions.CompanyManager.Name)
                return Permissions.CompanyManager;
